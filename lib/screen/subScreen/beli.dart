...
import 'package:zetproject/controller/productController.dart';
...
class _BeliState extends State<Beli> {
  final countController = Get.put(ProducController());
